...
@dataset_registry(dataset_type="CIFAR10",
...
@dataset_registry(dataset_type="MNIST",
                  framework="onnxrt_qlinearops, onnxrt_integerops",
                  dataset_format='')
class MNIST(Dataset):
...
@dataset_registry(dataset_type="FashionMNIST",
                  framework="onnxrt_qlinearops, onnxrt_integerops",
                  dataset_format='')
...
@dataset_registry(dataset_type="ImageFolder",
                  framework="onnxrt_qlinearops, onnxrt_integerops",
                  dataset_format='')
...
@dataset_registry(dataset_type="TFRecordDataset",
                  framework="tensorflow, tensorflow_itex",
                  dataset_format='')
...
@dataset_registry(dataset_type="ImageRecord",
                  framework="tensorflow, tensorflow_itex",
                  dataset_format='')
...
@dataset_registry(dataset_type="VOCRecord",
                  framework="tensorflow, tensorflow_itex",
                  dataset_format='')
