...
def ExportSingleImageGroundtruthToCoco(image_id: Union[int, str],
                                       ...
                                       groundtruth_boxes: np.array[np.float32],
                                       groundtruth_classes: np.array[np.integer],
                                       groundtruth_masks: Union[np.array[np.uint8], None] = None,
                                       groundtruth_is_crowd: Union[np.array[np.integer], None] = None) -> list:
...
def ExportSingleImageDetectionBoxesToCoco(image_id: Union[int, str], 
                                          ...
                                          detection_boxes: np.array[np.floating], 
                                          detection_scores: np.array[np.floating],
                                          detection_classes: np.array[np.integer]) -> list:
...
def ExportSingleImageDetectionMasksToCoco(image_id: Union[str, int], 
                                          category_id_set: Set[int],
                                          detection_masks: np.array[np.uint8], 
                                          detection_scores: np.array[np.floating],
                                          detection_classes: np.array[np.integer]) -> list:
